                        ...
                        >
                          ...
                          <TableCell
                            ...
                            sx={{paddingRight: 1.3,
                              paddingLeft: 1.5, 
                              fontWeight: 500,
                              color: portfolio.historicalSongValue[track.holding_id][1].rank -
                              portfolio.historicalSongValue[track.holding_id][0].rank   > 0 ? "#06f202" :
                              portfolio.historicalSongValue[track.holding_id][1].rank -
                              portfolio.historicalSongValue[track.holding_id][0].rank < 0 ? "#f71500" : "#e6bb00"          
                             }}>
                            {portfolio.historicalSongValue[track.holding_id][1].rank -
                            portfolio.historicalSongValue[track.holding_id][0].rank  > 0 ? "+" : ""  }   
                            {((track.current_price /
                            priceObject[portfolio.historicalSongValue[track.holding_id][1].rank]
                             - 1)*100).toFixed(2)}%
                          </TableCell>
                          :
                          <TableCell
                          ...
                          <TableCell
                            ...
                            sx={{paddingRight: 1.3,
                              paddingLeft: 1.5, 
                              fontWeight: 500,
                              color: portfolio.historicalSongValue[track.holding_id][portfolio.historicalSongValue[track.holding_id].length - 1].rank -
                              portfolio.historicalSongValue[track.holding_id][0].rank   > 0 ? "#06f202" :
                              portfolio.historicalSongValue[track.holding_id][portfolio.historicalSongValue[track.holding_id].length - 1].rank -
                              portfolio.historicalSongValue[track.holding_id][0].rank < 0 ? "#f71500" : "#e6bb00"          
                             }}>
                            {portfolio.historicalSongValue[track.holding_id][portfolio.historicalSongValue[track.holding_id].length - 1].rank -
                            portfolio.historicalSongValue[track.holding_id][0].rank  > 0 ? "+" : ""  }   
                            {((track.current_price /
                            priceObject[portfolio.historicalSongValue[track.holding_id][portfolio.historicalSongValue[track.holding_id].length - 1].rank]
                             - 1)*100).toFixed(2)}
                          </TableCell>
                          ...
                          <TableCell
                            ...
                            portfolio.historicalSongValue[track.holding_id][0].rank  > 0 ? "+" : ""  }   
                            {portfolio.historicalSongValue[track.holding_id][1].rank - 
                            portfolio.historicalSongValue[track.holding_id][0].rank}
                          </TableCell>
                          :
                          <TableCell
                            align="left"
