...
router.get('/', rejectUnauthenticated, (req, res) => {
    const queryText = `WITH old_movers AS (
        ...
        SELECT concat(song_charts.spotify_song_id, song_charts.spotify_playlist_id), song_charts.spotify_playlist_id, song_charts.spotify_song_id, song_charts.song_name, song_charts.artist, song_charts.id, song_charts.rank - old_movers.rank AS movement, song_charts.rank
        FROM song_charts
        ...
        GROUP BY concat(song_charts.spotify_song_id, song_charts.spotify_playlist_id), song_charts.spotify_playlist_id, song_charts.spotify_song_id, song_charts.song_name, song_charts.artist, song_charts.id, movement, song_charts.rank
